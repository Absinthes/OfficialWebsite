    ...
    <div className={classNames(styles.introduce, "w-1200px mx-auto")}>
      ...
      >
        ...
        <p className="w-502px color-#666666 lh-28px mt-20px">
          为了助力芜湖在全省率先打造“可防可控可治、可改善预后”的数字化智能化“儿童青少年近视防控及眼健康管理模式”、“老年人眼健康及慢病管理模式”，有效提高儿童青少年和老年人视力和眼健康水平，树立“光明芜湖”全国标杆，在市政府的关心支持下，红谷医疗在鸠江区落地设立芜湖明瞳数字健康科技有限公司（以下简称“芜湖明瞳”），由红谷医疗控股，拟邀请市国有资本、省国有资本及战略投资基金等多方参投。
        </p>
      </div>
      <div>
